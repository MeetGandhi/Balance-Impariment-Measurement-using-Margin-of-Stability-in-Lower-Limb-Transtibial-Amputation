...
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just after initiating RHS'));
hold off
...
ylabel('Shortest distance b/x Extrapolated CoM and Base of Support')
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just before LTO'));
hold off
...
ylabel('Shortest distance b/x Extrapolated CoM and Base of Support')
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just after LTO'));
hold off
...
ylabel('Shortest distance b/x Extrapolated CoM and Base of Support')
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just before LHS'));
hold off
...
ylabel('Shortest distance b/x Extrapolated CoM and Base of Support')
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just after LHS'));
hold off
...
ylabel('Shortest distance b/x Extrapolated CoM and Base of Support')
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just before RTO'));
hold off
...
ylabel('Shortest distance b/x Extrapolated CoM and Base of Support')
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just after RTO'));
hold off
...
for A_A = 3:length(plts) % as we do not processed data of S1 and S2 yet
    ...
    for B_B = 1:length(plts(A_A).ty)
        for D_D = 1:length(plts(A_A).ty(B_B).tn)
            mos10_a=[mos10_a,plts(A_A).ty(B_B).tn(D_D).stab.mos10_avg];
            mos10_s=[mos10_s,plts(A_A).ty(B_B).tn(D_D).stab.mos10_std];
        end
    end
    mos10_ag=[mos10_ag;mos10_a];
    mos10_sg=[mos10_sg;mos10_s];
end
h=barwitherr(mos10_sg,mos10_ag);
set(gca,'XTickLabel',{'S3','S4','S5'})
legend('BL1','BL2','BL3','T1','T2','T3')
% if A_A==5
%     set(gca,'XTickLabel',{'S3','S4','S5'})
...
ylabel('Shortest distance b/x Extrapolated CoM and Base of Support')
set(h(1),'FaceColor','k');
title(strcat('General Margin of Stability just before terminating RHS'));
hold off
